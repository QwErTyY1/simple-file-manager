...
|
*/
$config['base_url'] = 'http://simplefilemanager/';
...
|--------------------------------------------------------------------------
|
| Typically this will be your signup.php file, unless you've renamed it to
...
| example.com/signup.php?c=controller&m=function
|
...
// pagination config
$config['pagination']['full_tag_open'] = '<ul class="pagination product_page">';
...
$config['directory_map'] =  APPPATH . '/../UserContent/';